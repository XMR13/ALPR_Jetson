...
Use a descriptive name with date, e.g., `tao-pivot-2025-10-11`.

```
git tag checkpoint/tao-pivot-2025-10-11
git branch checkpoint/tao-pivot-2025-10-11
```
...
git show checkpoint/tao-pivot-2025-10-11 --no-patch --pretty=fuller
```
...
```
git switch -c restore/tao-pivot-2025-10-11 checkpoint/tao-pivot-2025-10-11
```

Alternatively, use the tag:

```
git switch -c restore/tao-pivot-2025-10-11 tags/checkpoint/tao-pivot-2025-10-11
```
...
```
git tag -d checkpoint/tao-pivot-2025-10-11
git branch -D checkpoint/tao-pivot-2025-10-11
```
