...
# Examples:
#   bash tools/trtexec_build.sh models/detector/yolox_s.onnx models/detector/yolox_s_fp16.engine --fp16
#   bash tools/trtexec_build.sh models/detector/yolox_s.onnx models/detector/yolox_s_int8.engine --int8 --calib=<cache>
